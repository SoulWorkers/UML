...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="_blank.html" data-title="课程简介">课程简介</a></li>
					<li><a data-href="_blank.html" data-title="课程特色">课程特色</a></li>
					<li><a data-href="/opencourses/textServlet?method=getAll" data-title="教材与参考资料" href="javascript:void(0)">教材与参考资料</a></li>
					<li><a data-href="/opencourses/admin/courseDetail-4.jsp" data-title="历史沿革">历史沿革</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-product">
